...
// const value = data.flatMap(dat => dat.values);
// console.log(value);
...
// const manUnder20 = people.some(man => man.age < 20);
// console.log(manUnder20);
...
// const numbersCouple = numbers.every(number => number % 2 === 0);
// console.log(numbersCouple);
...
// const numberCoup = numbers.find(number => number % 2 !== 0);
...
//     divide(value) {
//         if ( value === 0) {
//             console.error("число на 0 неможна ділити");
//         } else {
//             this.num /= value;
//         }
//         return this;
...
// const newUser = new Client('Lily', 'hello@gmail.com');
